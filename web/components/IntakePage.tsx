      ...
      <div className="min-h-screen bg-warm-bg">
        ...
        <section className="max-w-6xl mx-auto px-4 pb-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
            {[
              { n: '1', cor: 'bg-brand', titulo: 'Cadastro e escolha do tipo', desc: 'Informe nome, CPF, e-mail e telefone. Escolha atendimento particular ou via plano de saúde aceito pela plataforma.' },
              { n: '2', cor: 'bg-sage', titulo: 'Exame de HIV válido', desc: 'Envie seu exame Anti-HIV realizado há menos de 7 dias. Sem exame? O Facilita PrEP gera o pedido assinado digitalmente para você levar ao laboratório.' },
              { n: '3', cor: 'bg-brand-dark', titulo: 'Validação por IA + médico', desc: 'O exame é analisado automaticamente por IA sob supervisão médica. A validação é ágil, segura e sigilosa.' },
              { n: '4', cor: 'bg-sage', titulo: 'Formulário clínico', desc: 'Com o exame validado, preencha o formulário de triagem clínica. Os dados do cadastro já vêm pré-preenchidos.' },
              { n: '5', cor: 'bg-brand', titulo: 'Documentos no seu e-mail', desc: 'Receita, formulário clínico e ficha de cadastro — todos assinados digitalmente com certificado ICP-Brasil — chegam ao seu e-mail em horas.' },
              { n: '6', cor: 'bg-terra', titulo: 'Retire sua PrEP', desc: 'Com a receita em mãos, retire o TDF/FTC em qualquer farmácia ou drogaria. Pelo SUS, procure a UDM mais próxima.' },
