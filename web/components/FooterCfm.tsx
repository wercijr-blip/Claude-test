    ...
    <footer className="w-full bg-fp-dark text-slate-300 mt-auto">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 grid grid-cols-1 sm:grid-cols-3 gap-6 text-xs">
        ...
        <div className="space-y-1">
          ...
          <a
            href="https://instagram.com/facilitaprep"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-1.5 text-slate-300 hover:text-[#E1306C] transition-colors mt-1"
          >
            <svg
              className="w-3.5 h-3.5 shrink-0"
              fill="currentColor"
