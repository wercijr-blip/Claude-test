...
export default function Counter() {
  ...
  return (
    <section
      ref={ref}
      className="bg-fp-lavender-50 border-y border-fp-lavender-100 py-16 sm:py-20"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12">
          <div className="text-center">
            ...
            <p className="text-fp-dark text-lg font-medium mt-2">
              pacientes já protegidos
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 text-center sm:text-left">
            {[
              ...
              <div key={s.value}>
                ...
                <p className="text-fp-dark-soft text-xs mt-0.5 leading-tight max-w-[120px]">
                  {s.label}
                </p>
              </div>
            ))}
