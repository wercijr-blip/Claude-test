      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-14">
          ...
          <h2 className="font-display text-4xl sm:text-5xl text-fp-dark leading-tight">
            ...
            <br className="hidden sm:block" /> da saúde com a gente
          </h2>
        </div>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {testimonials.map((t, i) => (
            ...
            >
              ...
              {/* Quote */}
              <p className="text-fp-dark-soft text-sm leading-relaxed flex-1 mb-6">
                "{t.text}"
              </p>
        ...
        <p className="text-center text-fp-dark-soft text-xs mt-8">
          Depoimentos reais, dados anonimizados conforme LGPD para proteger a
