...
export const exames = mysqlTable(
  "exames",
  {
    id: int("id").primaryKey().autoincrement(),
    ...
    liberadoPorMedicoId: int("liberado_por_medico_id").references(
      () => users.id,
    ),
...
export const tcleAssinaturas = mysqlTable(
  "tcle_assinaturas",
  {
    id: int("id").primaryKey().autoincrement(),
    pacienteId: int("paciente_id")
...
export const nfseRegistros = mysqlTable(
  "nfse_registros",
  {
    id: int("id").primaryKey().autoincrement(),
...
export const consultasInicio = mysqlTable(
  "consultas_inicio",
  {
    id: int("id").primaryKey().autoincrement(),
    tokenId: int("token_id")
    ...
    pedidoDensitometriaS3Key: varchar("pedido_densitometria_s3_key", {
      length: 500,
    }),
...
export const precadastros = mysqlTable(
  "precadastros",
  {
    id: int("id").primaryKey().autoincrement(),
    // PII encriptado
...
export const satisfacaoPesquisas = mysqlTable(
  "satisfacao_pesquisas",
  {
    ...
    respondidoEm: datetime("respondido_em")
      .notNull()
      .default(sql`CURRENT_TIMESTAMP`),
  },
  (t) => ({
...
export const pesquisaTokens = mysqlTable(
  "pesquisa_tokens",
  {
    pacienteId: int("paciente_id")
      .primaryKey()
...
export const dlqJobs = mysqlTable(
  "dlq_jobs",
  {
    id: int("id").primaryKey().autoincrement(),
