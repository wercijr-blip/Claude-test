...
export const openApiSpec = {
  ...
  tags: [
    ...
    {
      name: "Operações",
      description: "Métricas e status operacional (requer x-ops-token)",
    },
    { name: "Upload", description: "Upload de exames" },
    { name: "Webhooks", description: "Integrações externas (Asaas)" },
    {
      name: "tRPC",
      description: "Endpoints tRPC — chamados via JSON-RPC em /trpc/*",
    },
  ],
  components: {
    securitySchemes: {
      opsToken: {
        ...
        name: "x-ops-token",
        description:
          "Token de operações definido pela variável de ambiente `OPS_TOKEN`",
      },
    },
    schemas: {
      HealthBasic: {
          ...
          checks: {
            ...
            items: {
              ...
              properties: {
                ...
                error: {
                  type: "string",
                  description: "Presente apenas quando ok=false",
                },
              },
              required: ["name", "ok"],
            },
      ...
      Metrics: {
        ...
        properties: {
          ...
          queues: {
            type: "object",
            description:
              "Contagem de jobs aguardando em cada fila (-1 = workers não iniciados)",
            properties: {
              pdf: { type: "integer" },
        ...
        properties: {
          llm: {
            ...
            properties: {
              today: {
                type: "integer",
                description: "Chamadas de IA hoje",
                example: 15,
              },
              limit: {
                type: "integer",
              ...
              alert: {
                type: "boolean",
                description: "true quando ≥ 80% do limite foi usado",
              },
            },
      ...
      Error503: {
        ...
        properties: {
          error: {
            type: "string",
            example: "OPS_TOKEN não configurado no servidor",
          },
        },
        required: ["error"],
      },
  ...
  paths: {
    "/health": {
      get: {
        ...
        description:
          "Verifica conectividade com o banco de dados e Redis. Não requer autenticação.",
    ...
    "/health/deep": {
      get: {
        ...
        description:
          "Verifica conectividade com banco, Redis e AWS S3. Mais lento — use para diagnóstico.",
    ...
    "/health/version": {
      get: {
        ...
        description:
          "Confirma que o deploy chegou à produção e qual bundle Vite está sendo servido.",
    ...
    "/health/observability": {
      get: {
        ...
        description:
          "Confirma que o Sentry está configurado no servidor. Requer `x-ops-token`.",
    ...
    "/upload": {
      post: {
              ...
              schema: {
                ...
                properties: {
                  file: {
                    ...
                    format: "binary",
                    description:
                      "Arquivo do exame (JPEG, PNG, PDF, WEBP — máx 10 MB)",
                  },
                  tipoExame: {
                    type: "string",
                    enum: [
        ...
        responses: {
          ...
          "400": {
            description:
              "Arquivo inválido (tipo não suportado, tamanho excedido, qualidade insuficiente)",
            content: {
              "application/json": {
                schema: {
                  type: "object",
                ...
                properties: {
                  ...
                  payment: {
                    ...
                    properties: {
                      ...
                      externalReference: {
                        type: "string",
                        description: "ID interno (pacienteId ou consultaId)",
                      },
                    },
                  },
                },
  ...
  "x-trpc-reference": {
    ...
    procedures: {
      "auth.iniciarLogin": {
        type: "query",
        description:
          "Inicia o fluxo OAuth — retorna URL de redirecionamento Google",
        access: "public",
      },
      "auth.callback": {
        type: "mutation",
      ...
      "token.validar": {
        type: "mutation",
        description:
          "Valida token de acesso do paciente e cria sessão temporária",
        access: "public",
      ...
      "paciente.salvarDadosPessoais": {
        type: "mutation",
        description:
          "Salva/atualiza dados pessoais do paciente (CPF criptografado via AES-256-GCM)",
        access: "protected",
      },
      ...
      "medico.aprovar": {
        type: "mutation",
        description:
          "Aprova paciente e dispara geração de PDF com assinatura ICP-Brasil",
        access: "medico",
      },
      "medico.rejeitar": {
        type: "mutation",
      ...
      "me.requestAnonymization": {
        type: "mutation",
        description:
          "Solicita anonimização de dados pessoais (LGPD — Art. 18 IV)",
        access: "protected",
        rateLimit: "3 req/hora por usuário",
      },
      "twoFactor.setup": {
