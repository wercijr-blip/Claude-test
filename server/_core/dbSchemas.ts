...
export const condutaDbSchema = z
  .object({
...
export const prescricaoDbSchema = z
  .object({
    modalidade: z.string(),
    posologia: z.string(),
...
const sbisMetadataDbSchema = z
  .object({
    ...
    grauConfianca: z.enum(["Alto", "Moderado", "Baixo", "Insuficiente"]),
    fundamentacao: z.array(z.string()),
    limitacoes: z.array(z.string()),
    nivel: z.string(),
    aviso: z.string(),
    guidelinesVersion: z.string().optional(),
  })
  .optional();

export const resultadoIaDbSchema = z
  .object({
    tipoExame: z.enum([
      "hiv",
      "hepatite_b",
