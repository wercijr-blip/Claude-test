...
describe('filtrarExamePorStatus', () => {
  ...
  it('pendente retorna true para status pendente', () => {
    expect(filtrarExamePorStatus({ status: 'pendente' }, 'pendente')).toBe(true)
  })

  it('pendente retorna false para aprovado', () => {
    expect(filtrarExamePorStatus({ status: 'aprovado' }, 'pendente')).toBe(false)
  })

  it('validado retorna true para aprovado', () => {
    expect(filtrarExamePorStatus({ status: 'aprovado' }, 'validado')).toBe(true)
  })

  it('validado retorna true para validado', () => {
    expect(filtrarExamePorStatus({ status: 'validado' }, 'validado')).toBe(true)
  })

  it('validado retorna false para pendente', () => {
    expect(filtrarExamePorStatus({ status: 'pendente' }, 'validado')).toBe(false)
  })

  it('rejeitado retorna true para rejeitado_ia', () => {
    expect(filtrarExamePorStatus({ status: 'rejeitado_ia' }, 'rejeitado')).toBe(true)
  })

  it('rejeitado retorna true para rejeitado', () => {
    expect(filtrarExamePorStatus({ status: 'rejeitado' }, 'rejeitado')).toBe(true)
  })

  it('liberado retorna true para liberado_manualmente', () => {
    expect(filtrarExamePorStatus({ status: 'liberado_manualmente' }, 'liberado')).toBe(true)
  })

  it('liberado retorna false para aprovado', () => {
    expect(filtrarExamePorStatus({ status: 'aprovado' }, 'liberado')).toBe(false)
  })
})
