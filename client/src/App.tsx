...
const SegundaParteInicio = lazy(
  () => import("./components/SegundaParteInicio.tsx"),
);
const FormularioPaciente = lazy(
  () => import("./components/FormularioPaciente.tsx"),
);
const MedicoDashboard = lazy(() => import("./components/MedicoDashboard.tsx"));
const SecretariaDashboard = lazy(
  () => import("./components/SecretariaDashboard.tsx"),
);
...
const PesquisaSatisfacao = lazy(
  () => import("./components/PesquisaSatisfacao.tsx"),
);
...
function FormularioGate({ pacienteId }: { pacienteId?: number }) {
  ...
  useEffect(() => {
    ...
    const aprovado =
      statusQuery.data.status === "aprovado" ||
      statusQuery.data.status === "aprovado_ia";
      ...
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-3">
          <p className="text-slate-600">
            Não foi possível verificar o status do atendimento.
          </p>
          <button
        ...
        <div className="flex-1">
          <Suspense fallback={<PageLoader />}>
            <Switch>
              ...
              <Route
                path="/pesquisa/:pacienteId/:token"
...
function PagamentoSucesso() {
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-500 text-sm mb-2">
            Se você acabou de pagar, verifique seu e-mail e WhatsApp — o link de
            acesso é enviado em instantes.
          </p>
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 max-w-md w-full text-center">
        <div
          className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4 ${confirmed ? "bg-emerald-100" : "bg-blue-50"}`}
        >
          {confirmed ? (
            <svg
            ...
            <div
              className="w-8 h-8 border-4 border-blue-100 border-t-blue-500 rounded-full animate-spin"
              role="status"
              aria-label="Verificando pagamento"
            >
        ...
        {erro ? (
          ...
          <>
            ...
            <p className="text-slate-500 text-sm">
              Te levando para o próximo passo…
            </p>
          ...
          <>
            ...
            {pollingTimedOut && !confirmed && (
              <p className="mt-3 text-sm text-amber-600 text-center">
                Aguardando confirmação do pagamento. Se já pagou, pode fechar
                esta tela — enviaremos o acesso por e-mail.
              </p>
            )}
          </>
        )}
