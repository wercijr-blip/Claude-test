    ...
    <div className="min-h-screen bg-fp-fog font-body">
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
            ...
            <div>
              <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-6">
                ...
                <span className="text-white/80 text-xs font-medium">
                  100% online · Receita em até 24 h
                </span>
              </div>
                ...
                <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 w-80 shadow-2xl">
                  <div className="flex items-center gap-3 mb-5">
                    <div className="w-10 h-10 rounded-xl bg-fp-lilac/30 flex items-center justify-center">
                      <svg
                        className="w-5 h-5 text-fp-lilac-soft"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        aria-hidden="true"
                    ...
                    {[
                      ...
                      <div key={label} className="flex items-center gap-2.5">
                        <div className="w-4 h-4 rounded-full bg-fp-success/30 flex items-center justify-center shrink-0">
                          <svg
                            className="w-2.5 h-2.5 text-fp-success"
                            fill="currentColor"
                            viewBox="0 0 20 20"
                            aria-hidden="true"
                          >
                  ...
                  <div className="mt-5 pt-4 border-t border-white/10">
                    <p className="text-white/50 text-xs">
                      Dr. Werciley Saraiva · CRM/DF 16381
                    </p>
                    <p className="text-fp-lilac-soft text-xs mt-0.5 font-medium">
                      Concluído em 18 min
                    </p>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-4 -left-8 bg-white rounded-2xl p-3 shadow-xl border border-fp-lavender-100">
                  <div className="flex items-center gap-2.5">
                    <div className="w-8 h-8 rounded-lg bg-fp-lavender-50 flex items-center justify-center">
                      <svg
                        className="w-4 h-4 text-fp-accent"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                        aria-hidden="true"
                    ...
                    <div>
                      <p className="text-fp-dark text-xs font-bold">
                        Sigilo total
                      </p>
                      <p className="text-fp-dark-soft text-[10px]">
            ...
            <div className="lg:hidden flex flex-wrap gap-2 -mt-4">
              {["🔒 Sigiloso", "✅ ICP-Brasil", "⚡ Até 24h"].map((t) => (
                <span
                  key={t}
                  className="bg-white/10 border border-white/20 text-white/70 text-xs px-3 py-1.5 rounded-full"
                >
                  {t}
                </span>
              ))}
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 grid grid-cols-2 sm:grid-cols-4 gap-6">
          {[
            ...
            <div key={s.value} className="text-center">
              <p className="font-display text-3xl text-fp-accent font-semibold">
                {s.value}
              </p>
              <p className="text-xs text-fp-dark-soft mt-1 leading-tight">
                {s.label}
              </p>
            </div>
          ))}
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            <p className="text-fp-accent text-sm font-semibold uppercase tracking-widest mb-2">
              Processo
            </p>
          ...
          <div className="grid sm:grid-cols-3 gap-6 lg:gap-8">
            {[
              ...
              <div
                key={i}
                className="relative bg-white rounded-3xl p-7 border border-fp-lavender-100 shadow-sm hover:shadow-md transition-shadow"
              >
                ...
                <h3 className="font-semibold text-fp-dark text-lg mb-2">
                  {item.title}
                </h3>
                <p className="text-fp-dark-soft text-sm leading-relaxed">
                  {item.desc}
                </p>
              </div>
            ))}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="text-fp-dark-soft text-lg leading-relaxed mb-8">
                Acesso à PrEP ainda é um desafio em muitas regiões. A Facilita
                PrEP resolve isso com uma plataforma segura, discreta e
                ...
                {[
                  ...
                  <li key={item} className="flex items-start gap-3">
                    <div className="w-5 h-5 rounded-full bg-fp-success/20 flex items-center justify-center shrink-0 mt-0.5">
                      <svg
                        className="w-3 h-3 text-fp-success"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        aria-hidden="true"
                      >
                    ...
                    <span className="text-fp-dark text-sm leading-relaxed">
                      {item}
                    </span>
                  </li>
                ))}
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                },
                {
                  ...
                  desc: "Da consulta à receita em menos de 24 horas úteis",
                },
                {
                  icon: "💊",
                  title: "PrEP + acompanhamento",
                  desc: "Protocolo periódico conforme PCDT/Ministério da Saúde",
                },
                {
                  icon: "🤝",
                ...
                <div
                  key={card.title}
                  className="bg-fp-fog rounded-2xl p-5 border border-fp-lavender-100"
                >
                  <span className="text-2xl mb-3 block">{card.icon}</span>
                  <h4 className="font-semibold text-fp-dark text-sm mb-1">
                    {card.title}
                  </h4>
                  <p className="text-fp-dark-soft text-xs leading-relaxed">
                    {card.desc}
                  </p>
                </div>
              ))}
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="bg-white rounded-3xl border border-fp-lavender-100 shadow-sm p-8">
              <div className="flex items-start gap-6 mb-6">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-fp-lavender-50 to-fp-lavender-100 flex items-center justify-center shrink-0">
                  <svg
                    className="w-10 h-10 text-fp-accent"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                    aria-hidden="true"
                ...
                <div>
                  <h3 className="font-display text-2xl text-fp-dark leading-tight">
                    Dr. Werciley Saraiva
                    <br />
                    Vieira Junior
                  </h3>
                  <p className="text-fp-accent font-semibold text-sm mt-1">
                    Médico Infectologista
                  </p>
                  <div className="flex flex-wrap gap-2 mt-2">
                    <span className="bg-fp-lavender-50 text-fp-accent text-xs font-medium px-2.5 py-1 rounded-full">
                      CRM/DF 16381
                    </span>
                    <span className="bg-fp-lavender-50 text-fp-accent text-xs font-medium px-2.5 py-1 rounded-full">
                      RQE 14486
              ...
              <p className="text-fp-dark-soft text-sm leading-relaxed mb-6">
                Especialista em Infectologia com atuação em prevenção do HIV,
                saúde sexual e medicina de viagem. Membro da Sociedade
                Brasileira de Infectologia, com ampla experiência no
                acompanhamento de pacientes em uso de PrEP e no manejo clínico
                de ISTs.
              </p>
              <div className="border-t border-fp-lavender-100 pt-5">
                <p className="text-xs text-fp-dark-soft font-medium mb-3 uppercase tracking-wider">
                ...
                <div className="grid grid-cols-3 gap-3">
                  {[
                    {
                      label: "CFM",
                      sub: "Telemedicina regulamentada",
                      icon: "⚕️",
                    },
                    {
                      label: "ICP-Brasil",
                      sub: "Receita com validade legal",
                      icon: "✅",
                    },
                    ...
                    <div
                      key={item.label}
                      className="bg-fp-fog rounded-xl p-3 text-center"
                    >
                      <span className="text-xl block mb-1">{item.icon}</span>
                      <p className="font-bold text-fp-dark text-xs">
                        {item.label}
                      </p>
                      <p className="text-fp-dark-soft text-[10px] leading-tight mt-0.5">
                        {item.sub}
                      </p>
                    </div>
                  ))}
            ...
            <div className="space-y-5">
              {[
                ...
                <div
                  key={i}
                  className="flex items-start gap-4 bg-white rounded-2xl p-5 border border-fp-lavender-100"
                >
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-12">
            ...
            <h2 className="font-display text-4xl sm:text-5xl text-fp-dark mb-4">
              Por que não o SUS ou clínica?
            </h2>
            <p className="text-fp-dark-soft text-lg max-w-xl mx-auto">
              Cada caminho tem suas vantagens. Veja onde a Facilita PrEP se
              diferencia.
            </p>
          </div>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr>
                  ...
                  <th className="py-3 px-3 sm:px-4 rounded-t-2xl bg-fp-dark text-white font-semibold text-center">
                    <span className="block text-xs text-fp-lilac-soft uppercase tracking-wider mb-0.5">
                      Recomendado
                    </span>
                    Facilita PrEP
                  </th>
                  <th className="py-3 px-3 sm:px-4 text-fp-dark font-medium text-center">
                    SUS / UBS
                  </th>
                  <th className="py-3 px-3 sm:px-4 text-fp-dark font-medium text-center">
                    Clínica presencial
              ...
              <tbody>
                {[
                  ...
                  {
                    label: "Retirada do medicamento",
                    fp: "✅ Farmácia SUS† ou particular",
                    sus: "UBS credenciada",
                    clinica: "Farmácia SUS† ou particular",
                    fpBold: false,
                  },
                ].map((row, i) => (
                  <tr
                    key={i}
                    className={i % 2 === 0 ? "bg-fp-fog" : "bg-white"}
                  >
                    <td className="py-3.5 pr-4 font-medium text-fp-dark text-xs sm:text-sm">
                      {row.label}
                    </td>
                    <td
                      className={`py-3.5 px-3 sm:px-4 text-center bg-fp-dark/5 ${row.fpBold ? "text-fp-accent font-bold" : "text-fp-dark font-medium"}`}
                    >
                      {row.fp}
                    </td>
                    <td className="py-3.5 px-3 sm:px-4 text-center text-fp-dark-soft">
                      {row.sus}
                    </td>
                    <td className="py-3.5 px-3 sm:px-4 text-center text-fp-dark-soft">
                      {row.clinica}
          ...
          <div className="text-fp-dark-soft text-xs mt-4 text-center space-y-1">
            <p>
              *SUS gratuito, mas com tempo de espera variável e cobertura
              geográfica limitada. Dados estimados.
            </p>
            <p>
              †PrEP disponível gratuitamente nas farmácias do Componente
              Especializado (CEAF/SUS) mediante receita válida.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 sm:py-24">
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-14">
            ...
            <p className="text-fp-dark-soft text-lg max-w-xl mx-auto">
              Disponível de forma particular ou para beneficiários de planos de
              saúde conveniados.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
            ...
            <div className="bg-white rounded-3xl border-2 border-fp-lavender-100 hover:border-fp-accent p-8 shadow-sm hover:shadow-md transition-all group">
              <div className="w-10 h-10 rounded-xl bg-fp-lavender-50 flex items-center justify-center mb-5">
                <svg
                  className="w-5 h-5 text-fp-accent"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  aria-hidden="true"
              ...
              <h3 className="font-display text-2xl text-fp-dark mb-1">
                Particular
              </h3>
              <div className="mb-4">
                <span className="text-3xl font-display font-semibold text-fp-accent">
                  R$ 150
                </span>
                <span className="text-fp-dark-soft text-sm ml-1">,00</span>
                <p className="text-fp-dark-soft text-xs mt-0.5">
                  Pagamento único · sem mensalidades
                </p>
              </div>
              <p className="text-fp-dark-soft text-sm leading-relaxed mb-5">
                Pagamento por PIX, cartão de crédito ou débito. Acesso liberado
              ...
              <ul className="space-y-2 mb-6">
                {[
                  ...
                  <li
                    key={item}
                    className="flex items-center gap-2 text-sm text-fp-dark"
                  >
                    <svg
                      className="w-4 h-4 text-fp-success shrink-0"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                      aria-hidden="true"
                    >
            ...
            <div className="bg-gradient-to-br from-fp-dark-mid to-fp-dark rounded-3xl border border-fp-dark p-8 shadow-lg relative overflow-hidden">
              <div className="absolute top-4 right-4">
                <span className="bg-fp-lilac text-fp-dark text-xs font-bold px-2.5 py-1 rounded-full">
                  Convênio
                </span>
              </div>
              ...
              <p className="text-white/60 text-sm leading-relaxed mb-5">
                Para beneficiários de planos conveniados. Atendimento coberto
                pelo seu plano, com a mesma agilidade.
              </p>
              <ul className="space-y-2 mb-6">
                {[
                  "Cobertura pelo seu plano",
                  "Sem custo adicional*",
                  "Mesma agilidade e sigilo",
                  "Receita ICP-Brasil",
                ].map((item) => (
                  <li
                    key={item}
              ...
              <p className="text-white/30 text-[10px] mt-3 text-center">
                *Sujeito à cobertura do seu plano
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={i}
                className="bg-fp-fog rounded-3xl p-7 border border-fp-lavender-100 flex flex-col"
              >
                ...
                <p className="text-fp-dark-soft text-sm leading-relaxed flex-1 italic">
                  "{t.text}"
                </p>
          ...
          <div className="mt-10 text-center">
            <p className="text-fp-dark-soft text-sm">
              Depoimentos anonimizados conforme LGPD · Identidades preservadas a
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={i}
                className="border border-fp-lavender-100 rounded-2xl overflow-hidden"
              >
                <button
                  className="w-full text-left px-6 py-5 flex items-center justify-between gap-4 hover:bg-fp-fog transition-colors"
                  onClick={() => setOpenFaq(openFaq === i ? null : i)}
                >
                  <span className="font-medium text-fp-dark text-sm sm:text-base">
                    {item.q}
                  </span>
                  <svg
          ...
          <div className="text-center mt-10">
            <a
              href="/duvidas"
              className="text-fp-accent text-sm font-medium hover:underline"
            >
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-fp-dark-mid via-fp-dark to-fp-dark-soft py-20 sm:py-28">
        ...
        <div className="relative max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <p className="text-fp-lilac-soft text-sm font-semibold uppercase tracking-widest mb-4">
            Comece hoje
          </p>
          ...
          <p className="text-white/60 text-lg mb-8 max-w-xl mx-auto">
            Junte-se aos +2.000 pacientes que já acessam a PrEP de forma rápida,
            segura e 100% online.
          </p>
          ...
          <p className="text-white/30 text-xs mt-6">
            Processo 100% digital · Receita com assinatura ICP-Brasil · LGPD
            compliant
          </p>
        </div>
      </section>
