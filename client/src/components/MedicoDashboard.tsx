          ...
          <div className="max-w-2xl space-y-4">
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 space-y-4">
              ...
              <div>
                ...
                />
                <p
                  className={`text-xs mt-1 ${comentario.length < 10 ? "text-amber-600 font-medium" : "text-slate-400"}`}
                >
                  {comentario.length}/10 mínimo
                  {comentario.length < 10 && comentario.length > 0
                    ? ` — faltam ${10 - comentario.length} caracteres`
                    : ""}
                </p>
              </div>
                ...
                title={
                  !acao
                    ...
                    : comentario.trim().length < 10
                      ? "Preencha o comentário (mínimo 10 caracteres)"
                      : ""
                }
