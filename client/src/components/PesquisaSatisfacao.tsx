...
export default function PesquisaSatisfacao() {
  ...
  const [conseguiuMedicacao, setConseguiuMedicacao] = useState<boolean | null>(
    null,
  );
      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl border border-slate-200 p-8 max-w-md w-full text-center">
          ...
          <p className="text-slate-500 text-sm">
            Sua resposta foi registrada. Isso nos ajuda a melhorar o
            atendimento.
          </p>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <p className="text-sm font-medium text-slate-700 mb-3">
              Achou o processo de atendimento fácil?
            </p>
          ...
          <div>
            <p className="text-sm font-medium text-slate-700 mb-3">
              Já conseguiu pegar a medicação PrEP?
            </p>
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
          ...
          <div>
            <p className="text-sm font-medium text-slate-700 mb-3">
              Você indicaria o Facilita PrEP para alguém?
            </p>
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
