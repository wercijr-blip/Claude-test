      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        >
          <input
            ...
            aria-describedby={
              errors.dataNascimento ? "dataNascimento-err" : undefined
            }
          />
        </Field>
        ...
        >
          <select
            ...
            aria-describedby={errors.sexo ? "sexo-err" : undefined}
          >
...
const btnPrimary =
  "bg-blue-600 hover:bg-blue-700 disabled:opacity-50 text-white font-medium py-2 px-6 rounded-lg transition-colors";
