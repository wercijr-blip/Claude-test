...
function _HeroIllustration() {
  return (
    ...
    >
      ...
      <polyline
        points="128,155 140,140 153,148 166,128 178,135 192,120"
        stroke="#3B82F6"
        strokeWidth="2.5"
        strokeLinecap="round"
      ...
      {/* Shield */}
      <path
        d="M225 55 L255 65 L255 98 C255 115 240 126 225 132 C210 126 195 115 195 98 L195 65 Z"
        fill="#A7F3D0"
        stroke="#34D399"
        strokeWidth="2"
      />
      <path
        d="M215 93 L224 102 L240 83"
        stroke="#059669"
        strokeWidth="3"
        strokeLinecap="round"
        strokeLinejoin="round"
      ...
      {/* Heart */}
      <path
        d="M68 108 C68 97 78 90 88 97 C98 90 108 97 108 108 C108 120 88 136 88 136 C88 136 68 120 68 108 Z"
        fill="#FCA5A5"
        stroke="#F87171"
        strokeWidth="1.5"
      />
      ...
      />
      <path
        d="M62 230 Q88 205 114 230 L114 258 Q88 244 62 258 Z"
        fill="#FED7AA"
        stroke="#FDBA74"
        strokeWidth="2"
      />
      ...
      />
      <path
        d="M152 99 L152 95 C152 91 172 91 172 95 L172 99"
        stroke="#60A5FA"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
      ...
      <div>
        ...
        {iniciarPagamento.isError && (
          <p className="text-center text-sm text-red-600 mt-3 px-4">
            {iniciarPagamento.error?.message ??
                ...
                <div>
                  ...
                  <label className="flex flex-col items-center justify-center w-full border-2 border-dashed border-slate-200 hover:border-brand rounded-2xl py-5 cursor-pointer bg-slate-50 hover:bg-brand-pale transition-all">
                    {carteirinhaUploading ? (
                      ...
                      <>
                        <svg
                          className="w-8 h-8 text-sage mb-2"
                          fill="none"
                          viewBox="0 0 24 24"
                          stroke="currentColor"
                        >
                        ...
                        <span className="text-xs text-slate-500 mt-1 max-w-[90%] truncate">
                          {carteirinhaNome}
                        </span>
                        <span className="text-xs text-brand mt-1 underline">
                          Trocar arquivo
                        </span>
                      </>
                    ) : (
