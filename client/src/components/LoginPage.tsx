      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white border border-stone-200 rounded-3xl shadow-sm p-8">
          ...
          <div className="flex flex-col items-center mb-8">
            <div className="w-14 h-14 bg-blue-600 rounded-2xl flex items-center justify-center mb-4 shadow-sm shadow-blue-200">
              <span className="text-white text-xl font-bold tracking-tight">CIS</span>
            </div>
            <h1 className="text-lg font-semibold text-stone-800">
              Bem-vindo, Dr. Werciley
            </h1>
            <p className="text-sm text-stone-400 text-center mt-1 leading-relaxed">
          ...
          {!GOOGLE_CLIENT_ID && (
            <p className="text-xs text-stone-400 text-center mt-3">
              Configure <code className="bg-stone-100 px-1 rounded">VITE_GOOGLE_CLIENT_ID</code>
            </p>
          )}
        </div>
        ...
        {/* Dev mode */}
        {isDev && (
          <div className="mt-4 bg-white border border-stone-200 rounded-2xl shadow-sm px-5 py-4">
            <p className="text-[10px] uppercase tracking-[0.12em] font-semibold text-stone-400 mb-3">
              Desenvolvimento
            </p>
            <div className="flex gap-2">
              {DEV_ROLES.map(({ role, label, goto }) => (
                <button
                  ...
                  className="flex-1 bg-stone-100 hover:bg-stone-200 text-stone-700 text-xs font-medium py-2 px-3 rounded-xl transition-colors disabled:opacity-50"
                >
