// Lazy GTM loader — only fires when the user has accepted analytics cookies (LGPD).
// Reads the same key written by CookieConsent.tsx ('cookies_accepted').
(function() {
  if (localStorage.getItem('cookies_accepted') !== 'all') return;
